// frontend/metsab/src/app/buyer-terms-conditions/page.tsx
// Purpose: Metsab Buyer Terms and Conditions page using shared legal component
...
export default async function BuyerTermsConditionsPage() {
  ...
  const content = getLegalContent('buyer-terms')
